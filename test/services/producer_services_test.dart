...
void main() {
  group("Test Producer services", () {
    ...
    test("Test tags list", () async {
      var producer = Producer(id: "8dd0df98-78cb-4029-9303-9f2c33d8992c", name: "Lucas Narciso", email: "lucasnar4@gmail.com", visible_producer: true, short_description: "Produtor local de software", address: "Lojinha de esquina verde", contact: "+55 99999-9999", opening_hours: "8h-17h", tags: ["sustentável"], lat: null, long: null);
